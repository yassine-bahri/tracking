...
import { Lock, User, Building, Phone, Mail, MapPin, Users, Car } from "lucide-react";
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold tracking-tight text-theme-darkPurple">Your Developer Profile</h1>
        {!isEditing && (
          <Button 
            onClick={toggleEdit} 
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-10">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium text-theme-darkPurple">
                    {profileData?.admin_uid || "Not assigned"}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 rounded-md border border-gray-200 flex items-center">
                    <Car className="h-8 w-8 text-theme-deepPurple mr-3" />
                    <div>
                      <div className="font-medium text-theme-darkPurple">Assigned Vehicles</div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-md border border-gray-200 flex items-center">
                    <Users className="h-8 w-8 text-theme-deepPurple mr-3" />
                    <div>
                      <div className="font-medium text-theme-darkPurple">Assigned Users</div>
                      <div className="text-sm text-muted-foreground">
